...
export type TransportMode = "car" | "bus" | "train" | "rickshaw";
...
export interface RouteData {
  ...
  mode: TransportMode;
  safetyScore?: number;
  timeSaved?: number; // seconds compared to slowest
}
...
interface MapsState {
  ...
  routeAlternatives: RouteData[];

  setTransportMode: (mode: TransportMode) => void;
  setSafetyMode: (enabled: boolean) => void;
  setRouteData: (data: RouteData | null) => void;
  setRouteAlternatives: (alternatives: RouteData[]) => void;
}
